...
class GUI:
    def __init__(self):
        ...
        Button(root, bg='#202023', fg='#b5cea8', text="MONITOR", activebackground='#202023', activeforeground='#b5cea8', font=('Arial', 9, 'bold'), command=lambda: threading.Thread(target="").start()).place(x=355, y=95, height=30, width=80)
